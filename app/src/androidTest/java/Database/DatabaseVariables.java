...
public final class DatabaseVariables {
    ...
    public static final String SQL_CREATE_TABLE_DECK = "CREATE TABLE "
            + Database.DatabaseVariables.TableDeck.TABLE_NAME + " ("
            + Database.DatabaseVariables.TableDeck.COLUMN_NAME_ID_DECK + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + Database.DatabaseVariables.TableDeck.COLUMN_NAME_PACKAGE_NAME + " TEXT NOT NULL,"
            + Database.DatabaseVariables.TableDeck.COLUMN_NAME_DATE_CREATED + " DATE,"
            + Database.DatabaseVariables.TableDeck.COLUMN_NAME_DATE_MODIFIED + " DATE" + " );";
    ...
    public static final String SQL_CREATE_TABLE_WORD_DECK = "CREATE TABLE "
            ...
            + " REFERENCES " + Database.DatabaseVariables.TableDeck.TABLE_NAME + "(" + Database.DatabaseVariables.TableDeck.COLUMN_NAME_ID_DECK + ")"
    ...
    public static final String SQL_DELETE_TABLE_DECK = "DROP TABLE IF EXISTS " + Database.DatabaseVariables.TableDeck.TABLE_NAME;
