...
public interface IUserSchema {
    ...
    String COLUMN_ALLOW_PRACTICE_ALL = "all_practice_all";
  ...
  String SQL_CREATE_TABLE_USER = "CREATE TABLE "
    ...
    String[] USER_COLUMNS = new String[]{COLUMN_USER_ID,
            ...
            COLUMN_DISPLAY_SPECIFIC_DECK, COLUMN_QUICK_TOGGLE_REVIEW, COLUMN_ALLOW_SEARCH_ON_QUERY_CHANGED, COLUMN_ALLOW_PRACTICE_ALL,
