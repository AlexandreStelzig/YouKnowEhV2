...
public interface  ICardSchema {
    ...
    // COLUMNS
    String[] CARD_COLUMNS = new String[] { COLUMN_CARD_ID,
            COLUMN_QUESTION, COLUMN_ANSWER, COLUMN_MORE_INFORMATION, COLUMN_DATE_CREATED,
            COLUMN_DATE_MODIFIED, COLUMN_PROFILE_ID, COLUMN_ARCHIVED };
}
